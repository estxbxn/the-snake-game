...
import StartGame from "../../../public/snake/snake-game.svg";
import {RESOLUTION} from "./constants";

export default function SnakeDisplay({snake, food, direction, gameStarted, startGame}: {
	snake: Accessor<XY[]>;
	food: Accessor<XY>;
			...
			<Show
				...
				fallback={
					<div class="flex flex-col items-center justify-center h-full">
						...
						<button
							class="bg-accent-200 rounded-xl mt-4 p-2 text-primary-100 hover:bg-emerald-500"
							onClick={startGame}
						>
							start-game
						</button>
