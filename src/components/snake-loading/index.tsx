...
export default function SnakeLoading() {
	...
	return (
		<div
			class="m-auto border-black snake-box-gradient shadow-snakeWindow backdrop-blur-[32px] p-4 rounded-lg w-fit flex flex-col sm:flex-row mx-auto">
			<div class="flex absolute top-0 left-0 h-full w-full">
				<div
					class="w-full h-fit bg-background bg-opacity-[90%] shadow-snakeGameWindow my-auto py-2 text-center text-white">
					Loading{
			...
			<div
				class="bg-background bg-opacity-[84%] shadow-snakeGameWindow rounded-lg snake-loading p-8 min-h-fit min-w-fit">
